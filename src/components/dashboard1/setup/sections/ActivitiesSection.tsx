  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-600">Persisted to itinerary_items — shown on calendar.</p>
      </div>
      ...
      <div className="rounded-xl border border-zinc-200 p-4">
        ...
        <button type="button" onClick={() => void addActivity()} className="mt-3 rounded-lg bg-zinc-900 px-4 py-2 text-sm font-medium text-white">
          Add activity
        </button>
      </div>
    </div>
