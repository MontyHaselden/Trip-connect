    ...
    <section className="py-16">
      <div className="mx-auto max-w-3xl rounded-2xl border border-zinc-200 bg-white px-6 py-8 sm:px-10">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">
          For one-time personal trips, Itinerary Live can use PayShare so the organiser does not have
        ...
        <p className="mt-4 rounded-xl bg-sky-50 px-4 py-3 text-sm text-zinc-700">
          ...
          Itinerary Live personal trip for $18. With PayShare, each person can pay $3 and the trip
          unlocks once everyone has paid.
        </p>
